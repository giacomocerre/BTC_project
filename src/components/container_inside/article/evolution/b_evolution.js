...
class Evolution extends React.Component {
    ...
    render() {
        return( 
        <section id="evolution" class="content_info">
                <article id="BTC_market" class="article">
                    <div class="article_width">
                        <h3 id="BTCm_main_title" class="article_title">BTC Market Cap Evolution</h3>
                        <p id="par_BTCm" class="par">Etiam pretium odio sed dapibus volutpat. Proin erat justo, maximus sit amet egestas et,
