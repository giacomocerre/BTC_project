...
function Cryptostory(props){
    return(
        <article id="cryptostory" className={props.class} style={{justifyContent:props.justify}}>
            <h1 className="article_title">Come sono nate le cryptovalute?</h1>
            <p className="title_explain"> Per rispodere dobbiamo andare ad analizzare punto per punto, gli avvenimenti principali, che spiegano come la cosa sia stata creata e, nel tempo, diramata.</p>
            <div id="cryptostory_content">
                <div id="timeline">
                    <div id="timeline_par">
                        <div id="par1" className="par">
                            <Fade left>
                                <div><img id="sato" className="point_icon" src="img/timeline/satoshi.svg" alt="satoshi nagamoto"/></div>
                            </Fade>
                            <Fade bottom>
                                <div>
                                    <div className="time_episode">
                        ...
                        <div id="par2" className="par">
                            <Fade left>
                                <div><img id="whitep" className="point_icon" src="img/timeline/white_p.svg" alt="white paper"/></div>
                            </Fade>
                            <Fade bottom>
                                <div>
                                    <div className="time_episode">
                        ...
                        <div id="par3" className="par">
                            <Fade left>
                                <div><img id="pizzas" className="point_icon" src="img/timeline/pizze.svg" alt="pizzas"/></div>
                            </Fade>
                            <Fade bottom>
                                <div>
                                    <div className="time_episode">
                        ...
                        <div id="par4" className="par">
                            <Fade left>
                            <div><img id="mtgox" className="point_icon" src="img/timeline/mtgox.svg" alt="mtgox"/></div>
                            </Fade>
                            <Fade bottom>
                                <div>
                                    <div className="time_episode">
                        ...
                        <div id="par5" className="par">
                            <Fade left>
                                <div><img id="grow_up" className="point_icon" src="img/timeline/up.svg" alt="grow up"/></div>
                            </Fade>
                            <Fade bottom>
                                <div>
                                    <div className="time_episode">
                        ...
                        <div id="par6" className="par">
                            <Fade left>
                                <div><img id="down_cr" className="point_icon" src="img/timeline/down.svg" alt="down"/></div>
                            </Fade>
                            <Fade bottom>
                                <div>
                                    <div className="time_episode">
                        ...
                        <div id="par7" className="par">
                            <Fade left>
                                <div><img id="grow_up_2" className="point_icon" src="img/timeline/up.svg" alt="grow up"/></div>
                            </Fade>
                            <Fade bottom>
                                <div>
                                    <div className="time_episode">
                        ...
                        <div id="par8" className="par">
                            <Fade left>
                                <div><img id="eth" className="point_icon" src="img/timeline/eth.svg" alt="ethereum"/></div>
                            </Fade>
                            <Fade bottom>
                                <div>
                                    <div className="time_episode">
