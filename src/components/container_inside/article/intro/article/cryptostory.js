                ...
                <div id="timeline">
                    <div id="timeline_par">
                        <div id="par1" class="par">
                            <img id="sato" class="point_icon" src="img/timeline/satoshi.svg" alt="satoshi nagamoto"/>
                        ...
                        <div id="par2" class="par">
                            <img id="whitep" class="point_icon" src="img/timeline/white_p.svg" alt="white paper"/>
                            <div class="time_episode">
                                <h5>White Paper</h5>
                        ...
                        <div id="par3" class="par">
                            <img id="pizzas" class="point_icon" src="img/timeline/pizze.svg" alt="pizzas"/>
                            <div class="time_episode">
                                <h5>Le Pizze</h5>
                        ...
                        <div id="par4" class="par">
                            <img id="mtgox" class="point_icon" src="img/timeline/mtgox.svg" alt="mtgox"/>
                            <div class="time_episode">
                                <h5>Mt.gox</h5>
                        ...
                        <div id="par5" class="par">
                            <img id="grow_up" class="point_icon" src="img/timeline/up.svg" alt="grow up"/>
                            <div class="time_episode">
                                <h5>Il primo Boom</h5>
                        ...
                        <div id="par6" class="par">
                            <img id="down_cr" class="point_icon" src="img/timeline/down.svg" alt="down"/>
                            <div class="time_episode">
                                <h5>Il crollo</h5>
                        ...
                        <div id="par7" class="par">
                            <img id="grow_up_2" class="point_icon" src="img/timeline/up.svg" alt="grow up"/>
                            <div class="time_episode">
                                <h5>La risalita</h5>
                        ...
                        <div id="par8" class="par">
                            <img id="eth" class="point_icon" src="img/timeline/eth.svg" alt="ethereum"/>
                            <div class="time_episode">
                                <h5>Ethereum & co.</h5>
