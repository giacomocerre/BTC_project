                ...
                <div id="sidebar">  
                    ...
                    : active === 4 ?    
                                <div id="tree">
                                    ...
                                    <a href="#decentralization"><p id="cap4" class="cap" style={{top:34+'%', right:50+"%"}}>Decentralizzata</p></a>
                                    ...
                                    <a href="#beyond_the_coin"><p id="cap5" class="cap" style={{top:44+'%', right:60+"%"}}>Oltre</p></a>
                                    ...
                                    <a href="#ComMinersGraph"><p id="cap7" class="cap" style={{top:34+'%', right:20+"%"}}>Consumi</p></a>
                                    ...
                                    <a href="#EmissionGraph"><p id="cap8" class="cap" style={{top:44+'%', right:15+"%"}}>Inquinamento</p></a>
                                    ...
                                    <a href="#RaeeGraph"><p id="cap9" class="cap" style={{top:56+'%', right:15+"%"}}>Smaltimento</p></a>
                                </div>
                    : null}                    
                </div>
        );
